...
# 3. Pull the first page of rows (sorting goes inside query_parameters)
curl -G 'https://api.fusionbase.com/api/v2/stream/data/4994292' \
  -H 'X-API-KEY: YOUR_API_KEY' \
  --data-urlencode 'skip=0' \
  --data-urlencode 'limit=10' \
  --data-urlencode 'query_parameters={"sort_keys": ["fb_datetime"], "sort_order": ["desc"]}'
```
